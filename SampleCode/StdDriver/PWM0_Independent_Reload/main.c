...
*/
    ...
    while(1)
    {
      Timer2_Delay(24000000,128,2000,1000);
      PWM0_ConfigOutputChannel(0,Independent,EdgeAligned,0x6FF,90);    // setting PWM channel 0 as 10% duty high of 0x6FF PWM period = 0x00B3
      PWM0_Reload();
      Timer2_Delay(24000000,128,2000,1000);
      PWM0_ConfigOutputChannel(0,Independent,EdgeAligned,0x6FF,10);    // setting PWM channel 0 as 10% duty high of 0x6FF PWM period = 0x00B3
      PWM0_Reload();
