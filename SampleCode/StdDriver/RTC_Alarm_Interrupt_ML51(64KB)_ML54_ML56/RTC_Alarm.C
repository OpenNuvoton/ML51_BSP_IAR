...
__data unsigned char rtc_alarm_flag;
...
//  SFRS=0;  printf_UART(" Current Time:%d/%bd/%bd %bd:%bd:%bd",sCurTime.u16Year,sCurTime.u8Month,sCurTime.u8Day,sCurTime.u8Hour,sCurTime.u8Minute,sCurTime.u8Second);
...
//  SFRS=0;  printf_UART(" RTC Alarm setting Time:%d/%bd/%bd %bd:%bd:%bd",sCurTime.u16Year,sCurTime.u8Month,sCurTime.u8Day,sCurTime.u8Hour,sCurTime.u8Minute,sCurTime.u8Second);
//        if (sCurTime.u8AmPm==1)
//          printf_UART("  AM");
//        else if (sCurTime.u8AmPm==2)
//          printf_UART("  PM")
...
//  SFRS=0;printf_UART(" RTC Start Tick and Wait Alarm.... \n");
