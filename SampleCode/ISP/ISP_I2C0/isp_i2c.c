...
__data volatile uint16_t count; 
...
void Init_I2C(void)
{
    SFRS=2;P2MF54&=0;P2MF54|=0x66;              //set SCL (P25) MFP //set SDA (P24) MFP
	  SFRS=1;P2M1|=0x30;P2M2|=0x30;         //set SCL (P25) is Quasi mode//set SDA (P24) is Quasi mode
...
#pragma vector=0x33                             /* interrupt 6 */
