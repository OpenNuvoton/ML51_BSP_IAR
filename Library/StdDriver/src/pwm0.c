...
void PWM0_ClockSource(unsigned char u8PWMCLKSource, unsigned char u8PWM0CLKDIV)
{
    ...
    switch (u8PWM0CLKDIV)
    {
        ...
        case 2:    PWM0CON1&=0xF8;PWM0CON1|=0x01; break;
...
void PWM0_DeadZoneEnable(unsigned char u8PWM0Pair, unsigned int u16PWM0DZValue)
{
    ...
    TA=0xAA;TA=0x55;PWM0DTEN|=BYTE_TMP;
    switch (u8PWM0Pair)
    {
 ...
 * @param[in] u8PWM0CLKDIV the divider value of PWM clock.  - \ref (1\2\4\8\16\32\64\128) 
 * @return none
 * @note   Modify the PWM clock source, also will modify PWM0 clock source
 * @example PWM1_ClockSource(PWM0_HIRC,128);
  */
void PWM1_ClockSource(unsigned char u8PWMCLKSource, unsigned char u8PWM0CLKDIV)
{
    ...
    switch (u8PWM0CLKDIV)
    {
        case 1:    PWM1CON1&=0xF8; break;
        case 2:    PWM1CON1&=0xF8;PWM1CON1|=0x02; break;
        case 4:    PWM1CON1&=0xF8;PWM1CON1|=0x02; break;
        case 8:    PWM1CON1&=0xF8;PWM1CON1|=0x03; break;
        case 16:   PWM1CON1&=0xF8;PWM1CON1|=0x04; break;
        case 32:   PWM1CON1&=0xF8;PWM1CON1|=0x05; break;
        case 64:   PWM1CON1&=0xF8;PWM1CON1|=0x06; break;
        case 128:  PWM1CON1&=0xF8;PWM1CON1|=0x07; break;
    }
}
