...
__no_init unsigned char temp @ 0x08; 
__data unsigned char g_u8Reg, g_u8Reg1,g_u8hiYear,g_u8loYear,g_u8hiMonth,g_u8loMonth,g_u8hiDay,g_u8loDay;
__data volatile unsigned char g_u8hiHour,g_u8loHour,g_u8hiMin,g_u8loMin,g_u8hiSec,g_u8loSec,g_u8DataTmp;
