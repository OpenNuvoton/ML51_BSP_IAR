...
BIT UART0PRINTFG,UART1PRINTFG,uart0_receive_flag, uart1_receive_flag;
...
/**
 * @brief       UART printf function open VCOM special for evulation board
 * @param       none
 * @return      none
 * @details     UART0 initial setting , UART0 define P3.1 TXD multi function setting and open baudrate as 115200.
 */
...
#if 1
/**
 * @brief       UART printf function special
 * @param       printf string
 * @return      none
 * @details     none
 * @note        max baud rate = 750khz when Fsys = 24MHz
