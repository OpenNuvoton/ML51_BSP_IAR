...
{
    SFRS=3;
    BYTE_TMP|= ((u8lcdIntStatus<<2)|u8lcdIntSel);
    TA=0xAA; TA=0x55; LCDCON1 = BYTE_TMP;
    BYTE_TMP = LOBYTE(u8lcdAlmValue);
    TA=0xAA; TA=0x55; LCDCPALCT0 = BYTE_TMP;
    BYTE_TMP = HIBYTE(u8lcdAlmValue);
    TA=0xAA; TA=0x55; LCDCPALCT1 = BYTE_TMP;
    LCDCON0 |= SET_BIT0;
}
