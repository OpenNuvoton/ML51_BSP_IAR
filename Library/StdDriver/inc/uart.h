...
__data extern  unsigned char UART0PRINTFG,UART1PRINTFG,uart0_receive_flag,uart1_receive_flag;
__data extern   unsigned char uart0_receive_data,uart1_receive_data;
